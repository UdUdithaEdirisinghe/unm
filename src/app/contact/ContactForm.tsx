    ...
    <form onSubmit={onSubmit} className="space-y-4">
      <div>
        ...
        <input
          ...
          className="w-full rounded-md bg-slate-800/60 border border-slate-700 px-3 py-2 text-slate-100 focus:outline-none focus:ring-2 focus:ring-indigo-500"
      ...
      <div>
        ...
        <textarea
          ...
          className="w-full rounded-md bg-slate-800/60 border border-slate-700 px-3 py-2 text-slate-100 focus:outline-none focus:ring-2 focus:ring-indigo-500 resize-y"
