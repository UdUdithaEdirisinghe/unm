  ...
  return (
    <section className="mx-auto max-w-3xl px-4 py-10">
      ...
      <div className="prose prose-invert mt-6 max-w-none space-y-6">
        <p>
          At Manny.lk, we value our customers and aim to provide the best service possible. Please read this policy carefully before making a purchase.
        </p>

        <div>
          <h2 className="text-xl font-semibold mt-8 mb-3">Returns (Defective or Incorrect Items)</h2>
          <ul>
            <li>If your product arrives defective or incorrect due to our error, please contact us immediately.</li>
          ...
          <ul>
            ...
            <li>Cash on Delivery (COD) refunds may be provided as Store Credit (valid for 1 year) or via Bank Transfer (to an account you provide).</li>
            <li>Shipping charges are non-refundable except where the return is due to our mistake (e.g., wrong item sent, defective product).</li>
            <li>Processing time: Approved refunds are typically processed within 7–10 business days (actual posting may vary by payment provider).</li>
            <li>Discretion: Manny.lk reserves the right to approve or deny refund requests based on case-by-case evaluation.</li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul>
            ...
            <li>If the product is defective or the wrong item was sent, this is handled under Returns (Defective or Incorrect Items).</li>
          </ul>
          ...
          <ul>
            ...
            <li>Customers are responsible for ensuring the product is securely packaged during return. Manny.lk is not responsible for damage caused during return shipping.</li>
          ...
          <ul>
            ...
            <li>If approved, we will issue store credit (not cash).</li>
          </ul>
        ...
        <div>
          ...
          <ul>
            <li>Warranty periods vary by product and are clearly stated on the product page (e.g., 6 months, 1 year, or checking warranty).</li>
            <li>Warranties cover manufacturing defects only.</li>
            <li>Physical damage, water damage, unauthorized repairs, or misuse will void the warranty.</li>
            <li>To claim a warranty, customers must provide proof of purchase (invoice/receipt).</li>
            <li>Warranty claims will be inspected within 7 working days, and if approved, the product will be repaired or replaced based on availability.</li>
          </ul>
        </div>
      </div>
    </section>
