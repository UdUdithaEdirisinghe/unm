  ...
  return (
    <section className="mx-auto max-w-3xl px-4 py-10">
      ...
      <div className="prose prose-invert mt-6 max-w-none space-y-6">
        <p>
          At Manny.lk, we make every effort to deliver orders promptly. Delivery timelines are estimates and may vary due to external factors.
        </p>
        ...
        <div>
          ...
          <ul>
            ...
            <li>Delivery timeframes are estimates only and may be affected by courier operations or external conditions.</li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul>
            ...
            <li>Shipping charges are non-refundable, except where a return is due to our mistake (e.g., wrong item sent, defective product).</li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul>
            <li>If your order arrives defective or incorrect due to our error, please contact us immediately.</li>
