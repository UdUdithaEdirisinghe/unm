  ...
  return (
    <div className="site-container">
      ...
      <div className="space-y-3">
        {items.map((it) => (
          <div key={it.id} className="rounded-xl border border-slate-800/60 bg-[rgba(10,15,28,0.6)] p-4">
            <div className="grid grid-cols-1 items-center gap-4 sm:grid-cols-12">
              ...
              <div className="sm:col-span-3">
                <div className="inline-flex items-center gap-2 rounded-md border border-slate-700 bg-slate-900/40 px-2 py-1">
                  ...
                  >−</button>
                  <span className="min-w-6 text-center text-slate-100 tabular-nums">{it.quantity}</span>
                  <button
                    type="button"
